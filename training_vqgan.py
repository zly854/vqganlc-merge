...
class ImageNetDataset(Dataset):
    def __init__(self, data_root, image_size, max_words=30, n_class=1000, partition="train", device="cpu"):
        ...
        _, self.clip_preprocessing = clip.load("/wangzedong/zly/.cache/clip_model/ViT-L-14.pt")
...
def get_args_parser():
    ...
    parser.add_argument("--pretrained", default=None, help="load from pre-trained checkpoint")
    ...
    parser.add_argument("--rate_cls", type=float, default=0.1, help="Classification Loss")
...
def main(args):
    ...
    if args.pretrained is not None:
        ...
        interpolate_pos_embed(model.o_encoder, state_dict)
        model.o_encoder.load_state_dict(state_dict)
